          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    "${profilecontroller.studentprofile.value!.firstName}",
                    style: TextStyle(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              "{controller.employeeInfo.value!.gradeId}",
                              style: TextStyle(
                                fontFamily: 'Montserrat',
                                color: darkblue,
                                fontSize: 20.sp,
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                "{controller.employeeInfo.value!.sectionId}",
                                style: TextStyle(
                                  fontFamily: 'Montserrat',
                                  color: darkblue,
                                  fontSize: 20.sp,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              "{controller.employeeInfo.value!.type}",
                              style: TextStyle(
                                fontFamily: 'Montserrat',
                                color: darkblue,
                                fontSize: 20.sp,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "{controller.employeeInfo.value!.dateOfBirth}",
                            style: TextStyle(
                              fontFamily: 'Montserrat',
                              color: darkblue,
                              fontSize: 20.sp,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              "{controller.employeeInfo.value!.phoneNumber}",
                              style: TextStyle(
                                fontFamily: 'Montserrat',
                                color: darkblue,
                                fontSize: 20.sp,
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Padding(
                              ...
                              child: Text(
                                "{ controller.employeeInfo.value!.bio}",
                                style: TextStyle(
                                  fontFamily: 'Montserrat',
                                  color: darkblue,
                                  fontSize: 14.sp,
